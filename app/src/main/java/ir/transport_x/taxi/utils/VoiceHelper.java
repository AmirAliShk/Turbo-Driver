...
import ir.transport_x.taxi.okHttp.AuthenticationInterceptor;
...
public class VoiceHelper {
    ...
    private void startDownload(final String urlString, final String fileName) {
        try {
            ...
            String dirPath = MyApplication.Companion.getDIR_ROOT() + MyApplication.Companion.getVOICE_FOLDER_NAME();
